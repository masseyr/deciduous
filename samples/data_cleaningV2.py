...
if __name__ == '__main__':
    ...
    # static vars--------------------------------------------------------------------------------------------
    md_cutoff = 90  # cutoff for Mahalanobis distance
    trn_perc = 80  # percentage of training samples
    md_clean = True  # if the sample should be cleaned
    mean_site = False  # if all the pixels at a site should be averaged

    # output file dirsctory
    outdir = "C:\\users\\rm885\\Dropbox\\projects\\NAU\\landsat_deciduous\\data\\"

    # input file directory
    infile = outdir + "ABoVE_AK_all_2010_samp.csv"

    # filenames
    if md_clean:

        trn_outfile = outdir + "ABoVE_AK_all_2010_trn_samp_clean_md{}.csv".format(str(md_cutoff))
        val_outfile = outdir + "ABoVE_AK_all_2010_val_samp_clean_md{}.csv".format(str(md_cutoff))
