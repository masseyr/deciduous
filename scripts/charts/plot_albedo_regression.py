...
if __name__ == '__main__':
    ...
    for albedo_var in albedo_list:
        ...
        plot_file = in_dir + "{}_{}_{}_{}_cutoff_{}_deg{}_{}.png".format(bandname, yvar, xvar, str(bin_limit),
                                                                         str(cutoff), deg,
        ...
        for x_val in x_range:
            ...
            for dict_ in val_dicts:
                if dict_[xvar] == x_val and dict_[yvar] > 0 and dict_[xvar_] >= cutoff:
