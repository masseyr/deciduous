...
def fit_regressor(args):
    ...
    :param args: List of args represents the following in the given order:
    ...
    llim: lower limit for regression
    ulim: upper limit for regression
    param: tuple with parameter values
    ...
    if rsq >= rsq_limit:
        ...
        out_dict['var_importance'] = ';'.join(list('{}:{}'.format(elem[0], str(elem[1]))
                                              for elem in model.var_importance()))
...
if __name__ == '__main__':
    ...
    infile = "d:/shared/" \
        ...
        "gee_data_cleaning_v28_median2.csv"
    codename = "v28_0"
    n_iterations = 10
