...
if __name__ == '__main__':
    ...
    trn_samp, val_samp = samp.random_partition(70)
    ...
    model.fit_data(trn_samp.format_data())
    ...
    pred = model.sample_predictions(trn_samp.format_data())
    print(pred)
    ...
    print(model.adjustment)
    pred_ = model.sample_predictions(samp.format_data(), sd_y=True)
    ...
    plt.plot(end_p, end_p, 'r-', ls='dashed', lw=1, zorder=1, )
