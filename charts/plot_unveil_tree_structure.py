...
def get_decision_paths(self):
    if not self.fit:
        ...
        dec_paths = estimator.tree_.decision_path(X_train.astype(np.float32))
...
print(estimator.tree_.n_outputs)

print(estimator.tree_.n_features)

dec_paths = estimator.tree_.decision_path(X_train.astype(np.float32))
print(dec_paths.shape)
...
print('\n')
print(X_train[12, :].astype(np.float32))

x = X_train[[12], :].astype(np.float32)
print(estimator.tree_.apply(x))


print(estimator.tree_.nodes)
exit()
